...
public class ScreenCollection {
	...
	static
	{
		...
		ScreenData.put(1003, new Screen(1003,1001,"SCREEN 1",null,5,5));
		ScreenData.put(1004, new Screen(1004,1002,"SCREEN 2",null,8,8));
		ScreenData.put(1005, new Screen(1005,1002,"SCREEN 3",null,5,5));
	}
